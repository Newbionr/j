...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		red = new FlxSprite(320, 10);
		red.frames = Paths.getSparrowAtlas('red_title');
		red.antialiasing = ClientPrefs.globalAntialiasing;
		red.animation.addByPrefix('idle', 'idle', 24);
		red.animation.play('idle');
		red.updateHitbox();

		kine = new FlxSprite(300, 0);
		kine.frames = Paths.getSparrowAtlas('kinemaster_title');
		kine.antialiasing = ClientPrefs.globalAntialiasing;
		kine.animation.addByPrefix('idle', 'idle', 24);
		kine.animation.play('idle');
		kine.updateHitbox();
	...
	override function update(elapsed:Float)
	{
		...
		if (initialized && !transitioning && skippedIntro)
		{
			...
			if(pressedEnter)
			{
				...
				FlxTween.tween(logoBl, {y:3000}, 3.2, {ease: FlxEase.expoInOut});
				FlxTween.tween(titleText, {y:3000}, 3.2, {ease: FlxEase.expoInOut});
				FlxTween.tween(kine, {y:3000}, 3.2, {ease: FlxEase.expoInOut});
				FlxTween.tween(red, {y:3000}, 3.3, {ease: FlxEase.expoInOut});
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['kinemaster mod by'], 15);
					#else
				...
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('pedroysker', 15);
					addMoreText('caioMoon!', 15);
					addMoreText('and few others', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				// credTextShit.text += '\nNight';
				case 16:
					addMoreText('Kinemaster'); // credTextShit.text += '\nFunkin';
			...
			if (playJingle) //Ignore deez
			{
				...
				switch(easteregg)
				{
					...
					default: //Go back to normal ugly ass boring GF
			            ...
			            FlxTween.tween(FlxG.camera, {zoom: 1}, 3.3, {ease: FlxEase.expoOut}); 
